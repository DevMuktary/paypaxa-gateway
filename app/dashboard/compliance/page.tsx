...
export default function CompliancePage() {
  ...
  const sections = [
    { id: 1, title: 'Business Profile', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"></rect><path d="M9 22v-4h6v4"></path><path d="M8 6h.01"></path><path d="M16 6h.01"></path><path d="M12 6h.01"></path><path d="M12 10h.01"></path><path d="M12 14h.01"></path></svg> },
    { id: 2, title: 'BVN & Identity', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg> },
    ...
    { id: 4, title: 'Registration Documents', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg> },
    { id: 5, title: 'Account Information', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="5" width="20" height="14" rx="2"></rect><line x1="2" y1="10" x2="22" y2="10"></line></svg> }
  ];
  ...
  return (
    <div className="compliance-layout">
      <style dangerouslySetInnerHTML={{__html: `
        ...
        .compliance-layout { display: flex; min-height: 100vh; background: var(--bg-gray); font-family: 'Inter', system-ui, sans-serif; align-items: flex-start; justify-content: center; padding: 40px 20px; gap: 32px; }

        /* ACTIVATION SIDEBAR */
        .activation-sidebar { width: 300px; background: #FFFFFF; border-radius: 16px; padding: 24px; box-shadow: 0 4px 20px rgba(0,0,0,0.03); border: 1px solid var(--border-color); flex-shrink: 0; position: sticky; top: 40px; }
        ...
        .section-item:hover { background: var(--bg-gray); }
        .section-item.active { background: var(--brand-dark); color: #FFFFFF; box-shadow: 0 4px 12px rgba(11, 25, 44, 0.15); }
        ...
        .badge { display: inline-block; padding: 4px 10px; border-radius: 100px; font-size: 11px; font-weight: 700; width: fit-content; text-transform: uppercase; }
        .badge-current { background: var(--brand-light); color: var(--brand-primary); }
        .badge-pending { background: #FEF3C7; color: #D97706; }
        .badge-completed { background: #D1FAE5; color: var(--success); }
        .section-item.active .badge-current { background: rgba(255,255,255,0.2); color: #FFFFFF; }

        /* MAIN CONTENT PANE */
        .content-pane { flex: 1; max-width: 700px; background: #FFFFFF; border-radius: 16px; box-shadow: 0 4px 20px rgba(0,0,0,0.03); border: 1px solid var(--border-color); padding: 40px; }
        .pane-title { font-size: 22px; font-weight: 800; color: var(--text-main); margin: 0 0 32px 0; border-bottom: 1px solid var(--border-color); padding-bottom: 16px; }

        /* FIELDSET STYLE INPUTS (Like Paymentpoint) */
        .input-group { position: relative; margin-bottom: 24px; border: 1px solid var(--border-color); border-radius: 8px; padding: 12px 16px; transition: 0.2s; background: #FFFFFF; }
        .input-group:focus-within { border-color: var(--brand-primary); box-shadow: 0 0 0 3px var(--brand-light); }
        .input-label { position: absolute; top: -10px; left: 12px; background: #FFFFFF; padding: 0 4px; font-size: 12px; font-weight: 600; color: var(--text-muted); }
        ...
        .type-option { flex: 1; padding: 16px; border: 2px solid var(--border-color); border-radius: 12px; text-align: center; cursor: pointer; transition: 0.2s; font-weight: 700; color: var(--text-muted); }
        .type-option.active { border-color: var(--brand-primary); background: var(--brand-light); color: var(--brand-primary); }

        /* UPLOAD BOXES (Like Paymentpoint) */
        .upload-card { border: 2px dashed var(--border-color); border-radius: 12px; padding: 32px; text-align: center; margin-bottom: 24px; position: relative; transition: 0.2s; }
        ...
        .upload-btn { display: inline-flex; align-items: center; gap: 8px; background: var(--brand-light); color: var(--brand-primary); border: 1px solid var(--brand-primary); padding: 10px 24px; border-radius: 8px; font-weight: 700; font-size: 14px; cursor: pointer; margin-bottom: 16px; transition: 0.2s; }
        ...
        /* BUTTONS */
        .submit-btn { width: 100%; background: var(--brand-dark); color: #FFFFFF; padding: 16px; border-radius: 8px; font-weight: 700; font-size: 16px; border: none; cursor: pointer; transition: 0.2s; margin-top: 24px; }
        .submit-btn:hover { background: #000000; }
        .submit-btn:disabled { background: var(--border-color); color: var(--text-muted); cursor: not-allowed; }
        ...
        .modal-content { background: #FFFFFF; width: 100%; max-width: 500px; border-radius: 16px; padding: 24px; box-shadow: 0 20px 40px rgba(0,0,0,0.2); }
        ...
        .sample-image-placeholder { width: 100%; height: 250px; background: var(--bg-gray); border: 2px dashed var(--border-color); border-radius: 12px; display: flex; align-items: center; justify-content: center; color: var(--text-muted); font-weight: 600; margin-bottom: 24px; }

        /* LIVENESS SCANNER */
        .camera-section { display: flex; flex-direction: column; align-items: center; }
        .video-mask { width: 280px; height: 280px; border-radius: 50%; overflow: hidden; position: relative; margin: 0 auto 32px auto; background: var(--text-main); box-shadow: 0 0 0 8px var(--bg-gray); }
        .video-feed { width: 100%; height: 100%; object-fit: cover; transform: scaleX(-1); }
        .progress-ring { position: absolute; inset: 0; border-radius: 50%; border: 8px solid transparent; border-top-color: var(--success); border-right-color: var(--success); transition: transform 0.1s linear; pointer-events: none; }
        .status-badge { display: inline-flex; align-items: center; gap: 8px; padding: 8px 16px; border-radius: 100px; font-weight: 700; font-size: 13px; margin-bottom: 24px; text-transform: uppercase; }

        @media (max-width: 900px) {
          .compliance-layout { flex-direction: column; padding: 20px 16px; }
          .activation-sidebar { width: 100%; position: relative; top: 0; display: grid; grid-template-columns: 1fr 1fr; gap: 8px; padding: 16px; }
          .sidebar-title { grid-column: 1 / -1; margin-bottom: 8px; }
          .content-pane { width: 100%; padding: 24px 16px; }
        ...
        <div className="modal-overlay" onClick={() => setSampleModal(null)}>
          <div className="modal-content" onClick={e => e.stopPropagation()}>
            <div className="modal-header">
              <div className="modal-title">Sample: {sampleModal}</div>
            ...
            <div className="sample-image-placeholder">
              [ Example Image of {sampleModal} ]
            </div>
            <button className="submit-btn" style={{ marginTop: 0 }} onClick={() => setSampleModal(null)}>Close</button>
          </div>
        </div>
      )}
        ...
        {sections.map((s) => {
          ...
          return (
            <div key={s.id} className={`section-item ${isActive ? 'active' : ''}`} onClick={() => setSection(s.id)}>
              ...
              <div className={`badge ${isActive ? 'badge-current' : isCompleted ? 'badge-completed' : 'badge-pending'}`}>
                {isActive ? 'In Progress' : isCompleted ? 'Approved' : 'Awaiting'}
              </div>
            </div>
          );
        })}
      ...
      <div className="content-pane">
        ...
        {step === 1 && (
          <div>
            ...
            <div className="type-selector">
              <div className={`type-option ${businessType === 'STARTER' ? 'active' : ''}`} onClick={() => setBusinessType('STARTER')}>Starter Business (Unregistered)</div>
              <div className={`type-option ${businessType === 'REGISTERED' ? 'active' : ''}`} onClick={() => setBusinessType('REGISTERED')}>Registered Corporate (CAC)</div>
            </div>

            {businessType !== 'UNSELECTED' && (
              <>
                <div className="input-group">
                  <label className="input-label">Business / Corporate Name</label>
                  <input type="text" className="input-field" placeholder="E.g. SmartReceipt Services" value={formData.corporateName} onChange={e => setFormData({...formData, corporateName: e.target.value})} />
                </div>

                <div className="input-group">
                  <label className="input-label">Business Address</label>
                  <input type="text" className="input-field" placeholder="Full operational address" value={formData.address} onChange={e => setFormData({...formData, address: e.target.value})} />
                </div>
                ...
                <div className="form-grid">
                  ...
                  <div className="input-group" style={{ marginBottom: 0 }}>
                    <label className="input-label">Business Website (Optional)</label>
                    <input type="text" className="input-field" placeholder="https://" value={formData.website} onChange={e => setFormData({...formData, website: e.target.value})} />
                  </div>
                </div>

                <button className="submit-btn" disabled={!formData.corporateName || !formData.address} onClick={() => setSection(2)}>Save and Proceed</button>
              </>
            )}
          </div>
        )}
          ...
          <div>
            ...
            <div className="form-grid">
              ...
              <div className="input-group">
                ...
                <input type="tel" className="input-field" placeholder="08000000000" value={formData.phone} onChange={e => handleNumberInput(e, 'phone', 15)} />
              </div>
            </div>
            ...
            <button className="submit-btn" disabled={!formData.firstName || !formData.lastName || !formData.dob || formData.bvn.length !== 11} onClick={() => setSection(3)}>Save and Proceed</button>
          </div>
        )}
        ...
        {step === 3 && (
          <div>
            ...
            <div className="camera-section">
              {modelLoading && <div className="status-badge" style={{ background: '#F1F5F9' }}>Loading AI...</div>}
              {!modelLoading && faceStatus === 'START' && <div className="status-badge" style={{ background: '#F1F5F9' }}>Ready</div>}
              {!modelLoading && faceStatus === 'NO_FACE' && <div className="status-badge" style={{ background: '#FEF2F2', color: '#EF4444' }}>No face detected</div>}
              {!modelLoading && faceStatus === 'MOVE_CLOSER' && <div className="status-badge" style={{ background: '#FEF2F2', color: '#EF4444' }}>Move Closer</div>}
              {!modelLoading && faceStatus === 'CENTER_FACE' && <div className="status-badge" style={{ background: '#FEF2F2', color: '#EF4444' }}>Center Face</div>}
              {!modelLoading && faceStatus === 'STATIC_DETECTED' && <div className="status-badge" style={{ background: '#FEF2F2', color: '#EF4444' }}>Static Image Detected!</div>}
              {!modelLoading && faceStatus === 'HOLD_STILL' && <div className="status-badge" style={{ background: '#EFF6FF', color: '#1A56DB' }}>Hold Still... {Math.floor(holdProgress)}%</div>}
              {!modelLoading && faceStatus === 'CAPTURED' && <div className="status-badge" style={{ background: '#D1FAE5', color: '#10B981' }}>Captured</div>}
              ...
              {faceStatus === 'START' && !modelLoading && (
                <button className="submit-btn" style={{ maxWidth: '280px', marginTop: 0 }} onClick={startScan}>Start Scan</button>
              )}

              {faceStatus === 'CAPTURED' && (
                <div style={{ display: 'flex', gap: '16px', width: '100%', maxWidth: '340px' }}>
                  <button className="submit-btn" style={{ background: '#F1F5F9', color: '#111827', marginTop: 0 }} onClick={retakePhoto}>Retake</button>
                  <button className="submit-btn" style={{ marginTop: 0 }} onClick={() => setSection(4)}>Looks Good</button>
                </div>
              )}
            </div>
          </div>
        ...
        {step === 4 && (
          <div>
            ...
            <div className="upload-card">
              <div className="upload-title">Valid Government ID</div>
              <button className="upload-btn">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="17 8 12 3 7 8"></polyline><line x1="12" y1="3" x2="12" y2="15"></line></svg>
                Choose a File
              </button>
              <div className="upload-formats">PNG, JPEG, JPG, PDF are accepted. Max file size 5MB</div>
            ...
            {businessType === 'REGISTERED' && (
              <div className="upload-card">
                <div className="upload-title">CAC Document</div>
                <button className="upload-btn">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="17 8 12 3 7 8"></polyline><line x1="12" y1="3" x2="12" y2="15"></line></svg>
                  Choose a File
                </button>
        ...
        {step === 5 && (
          <div>
            <h2 className="pane-title">Account Information (Corporate Bank Account)</h2>
            ...
            <div className="input-group" style={{ background: '#F8FAFC' }}>
              <label className="input-label">Account Name (Auto-Resolved)</label>
              <input type="text" className="input-field" disabled placeholder="Will appear after typing account number..." />
            </div>
            
            <Link href="/dashboard" style={{ textDecoration: 'none' }}>
              <button className="submit-btn">Complete Verification</button>
            </Link>
          </div>
        )}
